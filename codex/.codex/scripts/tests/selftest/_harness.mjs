 ...
 * 修改本文件后跑：`node .codex/scripts/gate-selftest.mjs`。
 */
...
export function fixtureProcess(processContent, extraFiles = {}) {
  fs.rmSync(FIXTURE_ROOT, { recursive: true, force: true, maxRetries: 5, retryDelay: 50 });
...
// R34：套件会真实签发 nonce 到 `.codex/hooks/`，故整轮自测前后做一次快照/还原，
