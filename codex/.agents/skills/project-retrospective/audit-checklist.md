...
| D1 | 业务代码在 DE 分派后出现，非 PM 代写 | `AGENTS.md` §5、`gate-chain.md` |

| D2 | 每条开发线有独立 QE 记录 | `gate-chain.md`、`AGENTS.md` §7 |
...
| E1 | 每批次 QE 后有批次集成测试行（非 hotfix） | `AGENTS.md` §7、`mechanical-gates.md` §8.3 |
...
| E6 | 未在 E2E 未通过时宣告完成 | `AGENTS.md` §5.13、`mechanical-gates.md` §8.3 |
...
| G1 | `AGENTS.md` 与 `README.md` E2E/测试表述与 `mechanical-gates.md` §8.3 一致 | TG-D-4 |
