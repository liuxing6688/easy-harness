/**
 * R17：存储对账记录机读、证据路径与 storageReconciliation 豁免。
 *
 * 入口：node .cursor/scripts/gate-selftest.mjs
 * 脚手架：./_harness.mjs；共享 fixture：./_fixtures.mjs
 */
import {
  test, fixtureProcess, assert, path, parseWorkflowState, isApiTestExempt,
  checkBatchStorageReconciliationReport, isStorageReconciliationExempt, isE2eExempt,
  checkReconEvidenceRef, snapshotReconDir, writeReconEvidence, clearReconDir,
  ensureDefaultReconEvidence,
} from './_harness.mjs';

import {
  liteModeConfirmSection, R14_PROGRESS_BATCH_DONE, API_REPORT_FILLED, API_EXEMPT_CONFIRM_PROCESS,
  API_NA_GATED, STORAGE_RECON_HEADER, STORAGE_RECON_SEP, STORAGE_RECON_BOTH,
  STORAGE_RECON_API_ONLY, STORAGE_RECON_E2E_ONLY, STORAGE_RECON_BAD_MEDIUM, STORAGE_RECON_EMPTY,
  STORAGE_EXEMPT_CONFIRM_PROCESS, STORAGE_NA_GATED,
} from './_fixtures.mjs';
