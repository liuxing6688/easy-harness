...
const ALT_CMD =
  'E2E_WEB_SERVER_COMMAND="npx vite-node ./server/index.ts" node .cursor/scripts/e2e-run.mjs --scope=batch --required-ids=R-001';
const NORMAL_E2E = 'node .cursor/scripts/e2e-run.mjs --scope=batch --required-ids=R-001';
