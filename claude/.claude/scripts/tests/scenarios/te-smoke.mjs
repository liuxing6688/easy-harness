...
const ALT_CMD =
  'E2E_WEB_SERVER_COMMAND="npx vite-node ./server/index.ts" node .claude/scripts/e2e-run.mjs --scope=batch --required-ids=R-001';
const NORMAL_E2E = 'node .claude/scripts/e2e-run.mjs --scope=batch --required-ids=R-001';
