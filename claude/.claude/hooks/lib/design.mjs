 ...
 * （见 .claude/harness/spec/mechanical-gates.md §8.4；机械判定边界坦诚披露，非隐藏漏洞）。
 */
...
/**
 * R9 软性提醒（非阻塞，说明权威见 `.claude/harness/spec/gate-chain.md` R9 脚注第 4 条（执行权威：Hook/脚本））：
...
/**
 * `.claude/harness/spec/mechanical-gates.md` §8.4：fail-open 时将异常持久化为 process.md 阻塞事件（cancelled 流程不写）。
