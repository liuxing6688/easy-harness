 ...
 * `node .claude/scripts/startup-smoke-run.mjs` 并取得 `gatePassed=true`。
 *
...
/** R17：具名存储介质关键词（与 `.claude/harness/spec/mechanical-gates.md` §8.3 一致；不含「其他」「不适用」） */
 ...
 * （`.claude/harness/spec/mechanical-gates.md` §8.3 说明权威；执行权威：Hook/脚本）。
...
export const LINT_FAILURE_GUIDANCE = Object.freeze({
  ...
  'lint-not-configured':
    ...
    '再由 quality-engineer 重跑 `node .claude/scripts/lint-run.mjs` 至 gatePassed=true。' +
